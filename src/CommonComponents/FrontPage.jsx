...
function FrontPage({url, imgUrl, firstHead, secondHead, thirdHead, customClassImg='', customClassDiv='', customClassFirstHead=''}) {
    return (
        ...
        <div className={`h-[60vh] w-full bg-black opacity-50 absolute z-40 ${customClassDiv}`}></div>
          ...
          <div className='w-full absolute z-50 top-[6.3rem] pr-2 flex flex-col items-center gap-8'>
